...
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,ACTIVE_START_DATE) VALUES (2002,'Classic PPs','Classic PPs','/classic-pps',CURRENT_TIMESTAMP);
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,ACTIVE_START_DATE) VALUES (2003,'Formulator PPs','Forumulator PPs','/formulator-pps',CURRENT_TIMESTAMP);
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,ACTIVE_START_DATE) VALUES (2004,'Merchandise','Merchandise','/merchandise',CURRENT_TIMESTAMP);
...
-- First create the Classic PP and Formulator PP 'base' products
------ Are these taxable??
INSERT INTO BLC_PRODUCT (PRODUCT_ID,  DEFAULT_CATEGORY_ID, URL) VALUES (1,2002,'/classic-pp/single');
INSERT INTO BLC_SKU (SKU_ID,DEFAULT_PRODUCT_ID,NAME,RETAIL_PRICE,TAXABLE_FLAG,ACTIVE_START_DATE.FULFILLMENT_TYPE) VALUES (1,1,'Classic PP',10.99,'Y',CURRENT_TIMESTAMP, 'DIGITAL');
INSERT INTO BLC_PRODUCT (PRODUCT_ID,  DEFAULT_CATEGORY_ID, URL) VALUES (2,2002,'/formulator-pp/single');
INSERT INTO BLC_SKU (SKU_ID,DEFAULT_PRODUCT_ID,NAME,RETAIL_PRICE,TAXABLE_FLAG,FULFILLMENT_TYPE) VALUES (2,2,'Formulator PP',10.99,CURRENT_TIMESTAMP, 'DIGITAL');

-- 5-card pack of Classic PP
INSERT INTO BLC_PRODUCT (PRODUCT_ID,  DEFAULT_CATEGORY_ID, URL) VALUES (1,2002,'/classic-pp/single');
INSERT INTO BLC_PRODUCT_BUNDLE (BUNDLE_PROMOTABLE,ITEMS_PROMOTABLE,PRICING_MODEL,PRODUCT_ID) VALUES (true,false,'BUNDLE',20);
INSERT INTO BLC_SKU (SKU_ID,DEFAULT_PRODUCT_ID,NAME,RETAIL_PRICE,TAXABLE_FLAG,ACTIVE_START_DATE,FULFILLMENT_TYPE) VALUES (1,1,'5-card Classic PP Pack',14.75,'Y',CURRENT_TIMESTAMP, 'DIGITAL');
INSERT INTO BLC_SKU_BUNDLE_ITEM (SKU_BUNDLE_ITEM_ID,QUANTITY,PRODUCT_BUNDLE_ID,SKU_ID) VALUES (-102, 1, 21, 1);

-- 10-card pack of Classic PP
